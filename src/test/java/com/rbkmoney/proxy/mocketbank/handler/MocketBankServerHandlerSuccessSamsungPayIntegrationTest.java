...
public class MocketBankServerHandlerSuccessSamsungPayIntegrationTest {

    private final static Logger LOGGER = LoggerFactory.getLogger(MocketBankServerHandlerSuccessSamsungPayIntegrationTest.class);

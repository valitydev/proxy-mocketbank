...
public class MocketBankServerHandlerSuccessGooglePayIntegrationTest {

    private final static Logger LOGGER = LoggerFactory.getLogger(MocketBankServerHandlerSuccessGooglePayIntegrationTest.class);
